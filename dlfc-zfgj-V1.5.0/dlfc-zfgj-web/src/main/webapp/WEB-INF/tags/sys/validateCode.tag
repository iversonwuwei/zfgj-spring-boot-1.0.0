...
<%@ attribute name="inputCssClass" type="java.lang.String" required="false" description="验证框Class"%>
...
<%@ attribute name="target" type="java.lang.String" required="false" description="jQuery Validation Engine 输入框属性"%>
<%@ attribute name="position" type="java.lang.String" required="false" description="jQuery Validation Engine 输入框属性"%>
<%@ attribute name="errormessage" type="java.lang.String" required="false" description="jQuery Validation Engine 输入框属性"%>
<input type="text" id="${name}" name="${name}" maxlength="5" class="${inputCssClass }" style="${inputCssStyle}" 
 data-prompt-target="${target}" data-prompt-position="${position}" data-errormessage-value-missing="${errormessage}"/>
