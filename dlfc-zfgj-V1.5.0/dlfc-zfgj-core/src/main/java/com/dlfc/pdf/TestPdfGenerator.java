...
import com.dlfc.pdf.pdf.bean.OverseaVo;
...
//		
//		qrCode.encoderQRCode("abcsss", "D:\\dev\\workspace\\fang-workspace\\dlfc_zfgj\\resources\\templates\\pdfTemplates\\images\\abc.png");
		
		overseaVo.setImagePath(ResourceLoader.getPath("templates/pdfTemplates/images"));

		// classpath 中模板路径
		String template = "templates/pdfTemplates/overseaAssistance.html";
		// classpath 路径
		...
		outputFile = outputFile == null ? new File(outputFileClass)
				...
				+ "/tmp/"
				+ UuidUtils.get32UUID() + ".pdf" : outputFile;
