...
package com.dlfc.admin.modules.sys.service;
...
import com.dlfc.admin.common.service.ServiceException;
...
import com.dlfc.admin.modules.sys.dao.MenuDao;
import com.dlfc.admin.modules.sys.dao.RoleDao;
import com.dlfc.admin.modules.sys.dao.UserDao;
...
//	private IdentityService identityService;
	...
	public BasePage<User> findUser(BasePage<User> page, User user) {
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By "+Global.getConfig("website")+"\r\n");
		sb.append("\r\n======================================================================\r\n");
...
//	}
	...
	public static void main(String[] args) {
		System.out.println(entryptPassword("111"));;
	}
