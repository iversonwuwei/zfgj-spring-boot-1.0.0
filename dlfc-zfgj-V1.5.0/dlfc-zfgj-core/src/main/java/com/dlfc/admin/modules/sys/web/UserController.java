...
import com.dlfc.admin.common.beanvalidator.BeanValidators;
...
import com.dlfc.admin.common.utils.excel.ExportExcel;
import com.dlfc.admin.common.utils.excel.ImportExcel;
...
public class UserController extends BaseController {
	...
	public String list(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
		BasePage<User> page = systemService.findUser(new BasePage<User>(request, response), user);
	...
	public BasePage<User> listData(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
		BasePage<User> page = systemService.findUser(new BasePage<User>(request, response), user);
		return page;
	}
    ...
    public String exportFile(User user, HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirectAttributes) {
		try {
            ...
            BasePage<User> page = systemService.findUser(new BasePage<User>(request, response, -1), user);
