...
*
* @name: RefreshTokenExpiredException.java 
* @description: 
*
* @version: 1.0
* @date : Apr 18, 2017 
...
/**
 * @name: RefreshTokenExpiredException
 * @description:
 * 
 * @version 1.0
 * @author dean
...
public class RefreshTokenExpiredException extends ApplicationException {
    ...
    public static final String ERROR_MESSAGE = "RefreshToken过期";

    public RefreshTokenExpiredException() {
        super(ERROR_MESSAGE);
        setErrorCode(CaErrorCode.REFRESH_TOKEN_EXPIRED.getErrorCode());
    }
}
