...
import com.dlfc.zfgj.dto.moblie.ContractStep3MDTO;
...
@Component
public class ContractStep3MValidator {

    public void validate(ContractStep3MDTO contractStep3DTO, String contractid) throws ApplicationException {
        ...
        Short flag = contractStep3DTO.isDepositSuperviseFlg() ? (short) 1 : 0;
        if(flag == 1){
            if (depositAmt == null) {
