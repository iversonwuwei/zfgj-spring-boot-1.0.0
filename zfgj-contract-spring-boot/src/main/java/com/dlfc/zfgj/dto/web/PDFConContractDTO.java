...
import com.dlfc.zfgj.common.pdf.pdf.DocumentVo;
import com.dlfc.zfgj.common.pdf.pdf.FillIntoMap;
import com.dlfc.zfgj.common.pdf.pdf.Fillable;
...
@Setter
@Component
public class PDFConContractDTO extends AbstractDocumentVo {


    private Fillable fillable = new FillIntoMap();
    ...
    /***房屋所有权人***/
    private List<HouseOwnerDTO> houCoOwnerList;

    /***实际承租使用人信息***/
    private List<HouseUserDTO> conHouseUserList;
    ...
    private List<SettlementCycleDTO> settlementCycleList; // 支付周期明细
    ...
    public Map<String, Object> fillDataMap() {
        ...
        return (Map<String, Object>) fillable.fill(vo);
    }
