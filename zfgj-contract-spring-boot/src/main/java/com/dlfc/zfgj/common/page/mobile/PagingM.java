...
public class PagingM {
    ...
    public PagingM(List conContracts) {
    ...
    public PagingM pagedResults(int pageSize) {
    ...
    public PagingM findPageByNum(Integer pageNo) {
    ...
    private List<ContractMDTO> subPage(int startIndex, int endIndex) {
